...
class UserModel(BaseResponse):
    ...
    telegram_Username: Optional[str] = Field(default=None, description="Ник в телеграмм", alias="telegramUsername")
    ...
    avatar_url: Optional[str] = Field(default=None, description="Ссылка на аватар пользователя", alias="avatarUrl")
    updated_At: datetime.datetime = Field(
        ...,
        description="Дата когда последний раз вносили изменения в профиль",
        alias="updatedAt"
    )
    created_At: datetime.datetime = Field(..., description="Дата когда был создан профиль", alias="createdAt")
