...
def register_user_with_retries(
    ...
    return request_with_retries(
        lambda: api_manager.auth_api.register_user(user_payload, expected_status=
                                                   [201, 503]),
                                                   success_status=201,
    )
...
def password_change_with_retries(
    ...
    *,
    ...
    return request_with_retries(
        lambda: api_manager.auth_api.password_change(user_id, payload, expected_status=[success_status, 503]),
